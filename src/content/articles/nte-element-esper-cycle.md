...
excerpt: "Cosmos, Anima, Incantation, Chaos, Psyche, and Lakshana — a gentle tour of NTE's elemental moods, not a homework sheet."
category: "guide"
...
seo:
  title: "Elements & the Esper Cycle"
  description: "A cozy overview of NTE elements—Cosmos, Anima, Incantation, Chaos, Psyche, and Lakshana—and how they shape team mood."
---
Elements in Neverness to Everness are less about memorizing charts and more about **how a squad feels** on the field. Each one carries a color, a rhythm, and a personality you will notice long before you optimize anything.
...
Start with one element you like visually, add a support from another family if you want variety, and only then explore reaction combos. Mochileaf character pages describe **vibe first**; build guides handle the optional numbers.
