...
export const articleBodies: Record<string, ArticleBodySection[]> = {
  ...
  'acnh-island-setup-beginner': [
    ...
    {
      heading: 'First placements',
      paragraphs: [
        'Keep Resident Services near your airport landing for visitors. Leave flat space for villager homes in a loose neighborhood so you can add paths later.',
        'Do not finalize your entire map before you can terraform; sketch zones instead (residential, market, forest, beach hangout).',
      ],
    },
  ],
  'acnh-villager-hunting-tips': [
    ...
    {
      heading: 'Mystery tours',
      paragraphs: [
        'Save Nook Miles tickets for dedicated hunting sessions. Empty a plot or keep an open campsite slot so you can invite someone home immediately.',
      ],
    },
  ],
  'nte-beginner-guide': [
    ...
    {
      heading: 'What to ignore at first',
      paragraphs: [
  ...
  'nte-redeem-codes': [
    ...
    },
    {
      ...
      paragraphs: [
        'Copy the code exactly, including caps. One account per code unless stated otherwise. Rewards usually arrive in the mailbox within a few minutes.',
      ],
    },
    {
      heading: 'Where new codes appear',
      paragraphs: [
        'Follow the official NTE channels and patch notes. Fan sites aggregate codes quickly; verify on a second source before sharing with friends.',
      ],
    },
  ],
  'nte-daily-routine': [
    {
      paragraphs: [
        'A sustainable NTE day: log in, claim mail, run dailies, spend natural resin, touch City Tycoon, log out. Add weekly bosses and events on reset days only.',
      ],
    },
    {
      heading: 'Every login',
      paragraphs: [
        'Collect idle rewards and mail. Complete daily commissions. Run one resin activity you need today (ascension books, credits, or weapon mats).',
      ],
    },
    {
